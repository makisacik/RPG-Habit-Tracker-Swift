...
struct ItemDatabase {
    ...
    static var allGear: [Item] {
        return [
            ...
            Item.gear(name: "soul_reaper", description: "soul_reaper_description", iconName: "char_sword_deadly", category: .weapon, rarity: .rare, value: 600),
            Item.gear(name: "thunder_axe", description: "thunder_axe_description", iconName: "char_sword_axe", category: .weapon, rarity: .epic, value: 1200),
            Item.gear(name: "storm_hatchet", description: "storm_hatchet_description", iconName: "char_sword_axe_small", category: .weapon, rarity: .uncommon, value: 400),
            Item.gear(name: "vipers_lash", description: "vipers_lash_description", iconName: "char_sword_whip", category: .weapon, rarity: .epic, value: 1100),
            ...
            Item.gear(name: "steel_guardian", description: "steel_guardian_description", iconName: "char_outfit_iron_2", category: .outfit, rarity: .rare, value: 600),
            Item.gear(name: "arcane_robes", description: "arcane_robes_description", iconName: "char_outfit_wizard", category: .outfit, rarity: .epic, value: 800),
            Item.gear(name: "noble_gown", description: "noble_gown_description", iconName: "char_outfit_dress", category: .outfit, rarity: .epic, value: 900),
            Item.gear(name: "infernal_armor", description: "infernal_armor_description", iconName: "char_outfit_fire", category: .outfit, rarity: .legendary, value: 1500),
            Item.gear(name: "shadow_cloak", description: "shadow_cloak_description", iconName: "char_outfit_bat", category: .outfit, rarity: .legendary, value: 1800),
            Item.gear(name: "crimson_vestments", description: "crimson_vestments_description", iconName: "char_outfit_red", category: .outfit, rarity: .legendary, value: 1200),
            Item.gear(name: "travelers_cloak", description: "travelers_cloak_description", iconName: "char_outfit_hoodie", category: .outfit, rarity: .uncommon, value: 400),
            ...
            Item.gear(name: "shadow_veil", description: "shadow_veil_description", iconName: "char_helmet_hood", category: .head, rarity: .rare, value: 800),
